...
# Load Dataset
file_path = input("Enter the full path to the Uttar Pradesh dataset file (e.g., 'UttarPradesh.csv'): ").strip()
...
# Define central point for Uttar Pradesh (Lucknow)
central_point = (26.8467, 80.9462)
...
# Save Predicted Map
prediction_map = folium.Map(location=[26.8467, 80.9462], zoom_start=6)  # Adjust for Uttar Pradesh
prediction_map.save('Predicted_LandCover_Map_UttarPradesh.html')
print("Predicted map saved as 'Predicted_LandCover_Map_UttarPradesh.html'.")
